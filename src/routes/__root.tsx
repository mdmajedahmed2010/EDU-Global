    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: "Abroad From Bangladesh",
          slogan: company.slogan,
          description:
            "AB STUDY HUB (Abroad From Bangladesh) is a premier higher education consultancy and specialized foreign language academy located at Commerce View Complex (4th Floor, Exim Bank Building), CDA Avenue, East Nasirabad, Panchlaish, Chattogram-4200. Providing European tuition-free public university admissions for Germany (APS & Blocked Account assistance), Denmark, Netherlands, Spain, Greece, Malaysia, Canada, UK, alongside Goethe German Language (A1–B2), Danish Language, IELTS Private Batches (Band 7.5+), Spoken English, and Kids English.",
          foundingDate: company.established,
          areaServed: ["Bangladesh", "Chattogram", "Worldwide"],
          email: company.email,
