    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: "Nexus Global / Nexus Academy",
          slogan: company.slogan,
          description:
            "Nexus Global Language and Skill Training Centre is a premier foreign language institute and international career consultancy located at Nowrin Tower, 3rd Floor (Level-3), East Side of Laldighi, Sadar, Jashore - 7400, with a liaison branch in Shin-Koiwa, Tokyo, Japan. Specializing in Japanese Language (N5/N4 packages), German Goethe A1, IELTS, Spoken English, Kids English, Japan SSW/Student Visas, and German university/Ausbildung admissions.",
          foundingDate: company.established,
          areaServed: ["Bangladesh", "Jashore", "Japan", "Worldwide"],
          email: company.email,
