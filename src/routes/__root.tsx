...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "RANS Scholarships" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "RANS Scholarships" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/log.jpg", type: "image/jpeg" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "RANS Scholarships is a premier study abroad consultancy and language academy located at 425 Rang Mohol Tower, Bandar Bazar, Sylhet, Bangladesh. Providing higher education admissions for Finland (January 2027 Joint Application), Europe, Canada, USA, UK, IELTS Preparation, Spoken English, Kids English, and 100% Free File Opening.",
          foundingDate: company.established,
          areaServed: ["Bangladesh", "Sylhet", "Worldwide"],
          email: company.email,
