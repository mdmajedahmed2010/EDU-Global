...
const recentActivities = [
  {
    flag: "🎧",
    student: "Tanvir A. (Kushtia)",
    action: "Booked Computer-Based IELTS Mock Test (300 BDT)",
    subtext: "Kushtia IELTS Care · Audio Lab with Headsets",
    time: "3 mins ago",
  },
  {
    flag: "🌟",
    student: "Sultana R. (Kushtia)",
    action: "Achieved Cambridge IELTS Overall Band 8.0",
    subtext: "Kushtia IELTS Care · Regular Master Batch",
    time: "11 mins ago",
  },
  {
    flag: "🇵🇹",
    student: "Mahfuz H. (Meherpur)",
    action: "Portugal Study Visa Application Lodged",
    subtext: "European Higher Education & Schengen Guidance",
    time: "24 mins ago",
  },
  {
    flag: "🗣️",
    student: "Kamrul I. (Chuadanga)",
    action: "Enrolled in Spoken English Fluency Batch",
    subtext: "Kushtia IELTS Care · Interactive Pronunciation Lab",
    time: "42 mins ago",
  },
  {
    flag: "🇨🇿",
    student: "Farzana K. (Kushtia)",
    action: "Czech Republic University Acceptance Received",
    subtext: "European Study Abroad Consultation Desk",
    time: "1 hour ago",
  },
  {
    flag: "👶",
    student: "Ayaan M. (Kushtia)",
    action: "Enrolled in Kids English Academy (Ages 5–14)",
    subtext: "Kushtia IELTS Care · Phonics & Vocabulary Lab",
    time: "2 hours ago",
  },
];
