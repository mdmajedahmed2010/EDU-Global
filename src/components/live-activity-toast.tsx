...
const recentActivities = [
  {
    flag: "🇯🇵",
    student: "Tanvir A. (Rajshahi)",
    action: "Enrolled in Japanese N5 Intensive Batch",
    subtext: "AcademiaZ · 100% Japan Standard Package",
    time: "3 mins ago",
  },
  {
    flag: "🇯🇵",
    student: "Sultana R. (Natore)",
    action: "Enrolled in Japanese N4 Exam Prep",
    subtext: "AcademiaZ · JLPT & NAT-TEST Preparation",
    time: "11 mins ago",
  },
  {
    flag: "🌸",
    student: "Mahfuz H. (Rajshahi)",
    action: "COE Approved: Tokyo Language Academy",
    subtext: "Japan Student Visa & Post-Arrival Guidance",
    time: "24 mins ago",
  },
  {
    flag: "🌟",
    student: "Kamrul I. (Rajshahi)",
    action: "Achieved IELTS Overall Band 7.5",
    subtext: "AcademiaZ Cambridge Mock Exam Batch",
    time: "42 mins ago",
  },
  {
    flag: "💼",
    student: "Farzana K. (Rajshahi)",
    action: "TITP / SSW Work Visa Profile Verified",
    subtext: "AcademiaZ Career in Japan Wing",
    time: "1 hour ago",
  },
  {
    flag: "👶",
    student: "Arif M. (Chapai Nawabganj)",
    action: "Enrolled in Kids English (Ages 5–14)",
    subtext: "AcademiaZ Kadirganj Campus Language Lab",
    time: "2 hours ago",
  },
];
